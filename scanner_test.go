...
func TestIdentificaTokenSemPalavraReservada(t *testing.T) {
	...
	verificarTokenSemPalavraReservada(t, "ERRO1", "123.", 0)
	...
	verificarTokenSemPalavraReservada(t, "comentario", "{asdas}", 0)
	verificarTokenSemPalavraReservada(t, "comentario", "{123}", 0)
	verificarTokenSemPalavraReservada(t, "comentario", "{{{}", 0)
	verificarTokenSemPalavraReservada(t, "comentario", "{;}", 0)
...
func TestScanner(t *testing.T) {
	...
	verificarTokenScanner(t, "ERRO1", "123.", 0)
	...
	verificarTokenScanner(t, "comentario", "{asdas}", 0)
	verificarTokenScanner(t, "comentario", "{123}", 0)
	verificarTokenScanner(t, "comentario", "{{{}", 0)
	verificarTokenScanner(t, "comentario", "{;}", 0)
